...
MCP_STATIC _CcmImStatus _CCM_IM_BtTranOnSm_InternalHandleEvent(_CcmIm_BtTranOnSm_Obj *thisObj, 
                                                               _CcmIm_BtTranOnSm_Event event,
                                                               void *eventData);
MCP_STATIC _CcmImStatus _CCM_IM_BtTranOnSm_HandlerTurnHciOn(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                            void *eventData);
MCP_STATIC _CcmImStatus _CCM_IM_BtTranOnSm_HandlerReadVersion(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                              void *eventData);
MCP_STATIC _CcmImStatus _CCM_IM_BtTranOnSm_HandlerAbortReadVersion(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                                   void *eventData);
MCP_STATIC _CcmImStatus _CCM_IM_BtTranOnSm_HandlerExecuteScript(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                                void *eventData);
MCP_STATIC _CcmImStatus _CCM_IM_BtTranOnSm_HandlerScriptCmdCompleted(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                                     void *eventData);
MCP_STATIC _CcmImStatus _CCM_IM_BtTranOnSm_HandlerScriptSetTranParmsCompleted(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                                              void *eventData);
MCP_STATIC _CcmImStatus _CCM_IM_BtTranOnSm_HandlerAbortTurnHciOn(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                                 void *eventData);
MCP_STATIC _CcmImStatus _CCM_IM_BtTranOnSm_HandlerAbortExecuteScript(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                                     void *eventData);
MCP_STATIC _CcmImStatus _CCM_IM_BtTranOnSm_HandlerTranOnCompleted(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                                  void *eventData);
MCP_STATIC _CcmImStatus _CCM_IM_BtTranOnSm_HandlerOnFailed(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                           void *eventData);
MCP_STATIC _CcmImStatus _CCM_IM_BtTranOnSm_HandlerTranOnAbortCompleted(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                                       void *eventData);
MCP_STATIC _CcmImStatus _CCM_IM_BtTranOnSm_PerformCompletion(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                             _CcmImStatus completionStatus);
MCP_STATIC void _CCM_IM_BtTranOnSm_CcmaMngrCb(CcmaMngrEvent *event);
MCP_STATIC _CcmImStatus _CCM_IM_BtTranOnSm_GetInitScriptFileName(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                                 const McpU8 *hciReadVersionEventParms,
                                                                 char *scriptFileName,
                                                                 McpUtf8 *scriptFileFullName);
MCP_STATIC McpBtsSpStatus _CCM_IM_BtTranOnSm_SpSendHciCmdCb(McpBtsSpContext *context,
                                                            McpU16 hciOpcode, 
                                                            McpU8 *hciCmdParms, 
                                                            McpUint hciCmdParmsLen);
MCP_STATIC McpBtsSpStatus _CCM_IM_BtTranOnSm_SpSetTranParmsCmdCb(McpBtsSpContext *context,
                                                                 McpUint speed, 
                                                                 McpBtSpFlowControlType flowCtrlType);
MCP_STATIC void _CCM_IM_BtTranOnSm_SpExecCompleteCmdCb(McpBtsSpContext *context, 
...
_CcmImStatus _CCM_IM_BtTranOnSm_HandleEvent(_CcmIm_BtTranOnSm_Obj *thisObj, 
                                            ...
                                            void *eventData)
{
    /* This function is called by the parent (BtTranSm) => we should initialize
     * the flag (this is the beginning of the process */
...
_CcmImStatus _CCM_IM_BtTranOnSm_InternalHandleEvent(_CcmIm_BtTranOnSm_Obj *thisObj, 
                                                    _CcmIm_BtTranOnSm_Event event,
                                                    void *eventData)
{
    _CcmImStatus status;
    ...
    /*
        Semaphore is locked here since this module receives events from CCMA. 

        A deadlock may occur in the following scenario:
        1. Parent locks the CCM-IM semaphore.
        2. Parent sends an event to this SM
        3. This SM calls HCIA, that, in turn, locks some transport semaphore
           (e.g., ESI stack semaphore).
        4. Parent sends another event to this SM, locking the CCM-IM semaphore,
           and attempts to access CCMA at the same time that:
        5. CCMA returns an event to this SM, in transport context (e.g., BTS).

        Now, 4 and 5 above will cause the parent's context to lock CCM-IM mutex,
        and try to lock transport semaphore at the same time that transport
        semaphore is already locked and tries to lock CCM-IM semaphore.
        ...
        The on-abort handling will not access CCMA. If the SM is waiting for a CCMA event,
        it just waits for the event to arrive and then aborts.
    */
    MCP_HAL_OS_LockSemaphore(thisObj->ccmImMutexHandle, MCP_HAL_OS_TIME_INFINITE); 
    
    MCP_VERIFY_FATAL((thisObj != NULL),
                     _CCM_IM_STATUS_INVALID_PARM,
                     ("_CCM_IM_BtTranOnSm_InternalHandleEvent: Null this"));
    MCP_VERIFY_FATAL((event < _CCM_IM_NUM_OF_BT_TRAN_ON_EVENTS),
                     _CCM_IM_STATUS_INVALID_PARM,
    ...
    MCP_VERIFY_FATAL((smEntry->action != NULL),
                     _CCM_IM_STATUS_NULL_SM_ENTRY, 
    ...
    if (status == _CCM_IM_STATUS_SUCCESS)
    {   
        /* Action completed synchronously => we transit to the next event by
         * calling the SM engine recursively, using the event stored in the SM info. */
        ...
        {
            status = _CCM_IM_BtTranOnSm_InternalHandleEvent(thisObj,
                                                            smEntry->syncNextEvent,
                                                            NULL);
        }
    }

    MCP_LOG_DEBUG(("_CCM_IM_BtTranOnSm_InternalHandleEvent: On Exit, State: %s",
                  _CCM_IM_BtTranOnSm_DebugStatetStr(thisObj->state)));
    
    MCP_FUNC_END();

    /* Unlocking AFTER MCP_FUNC_END() to make sure all paths (including erroneous)
     * will unlock before exiting */
...
void _CCM_IM_BtTranOnSm_StaticInitSm(void)
{
    ...
    {   
        for (btTranOnEventIdx = 0; btTranOnEventIdx < _CCM_IM_NUM_OF_BT_TRAN_ON_EVENTS; ++btTranOnEventIdx)
        {
            ...
            _ccmIm_BtTranOnSm_Data.sm[btTranOnStateIdx][btTranOnEventIdx].nextState =
                                                                _CCM_IM_INVALID_BT_TRAN_ON_STATE;
            _ccmIm_BtTranOnSm_Data.sm[btTranOnStateIdx][btTranOnEventIdx].syncNextEvent =
    ...
    _ccmIm_BtTranOnSm_Data.sm[_CCM_IM_BT_TRAN_ON_SM_STATE_NONE]
                             [_CCM_IM_BT_TRAN_ON_SM_EVENT_START].action =
                                                        _CCM_IM_BtTranOnSm_HandlerTurnHciOn;
    _ccmIm_BtTranOnSm_Data.sm[_CCM_IM_BT_TRAN_ON_SM_STATE_NONE]
                             [_CCM_IM_BT_TRAN_ON_SM_EVENT_START].nextState =
    ...
    _ccmIm_BtTranOnSm_Data.sm[_CCM_IM_BT_TRAN_ON_SM_STATE_TURN_HCI_ON]
                             [_CCM_IM_BT_TRAN_ON_SM_EVENT_HCI_IF_ON_COMPLETE].action =
                                                      _CCM_IM_BtTranOnSm_HandlerReadVersion;
    _ccmIm_BtTranOnSm_Data.sm[_CCM_IM_BT_TRAN_ON_SM_STATE_TURN_HCI_ON]
    ...
    /* {State Executing Script, Event HCI Command Completed} -> Executing Script
     * (no change, script still executing) */
    ...
    /* {State Executing Script, Event Execute Script Completed} -> None */
    _ccmIm_BtTranOnSm_Data.sm[_CCM_IM_BT_TRAN_ON_SM_STATE_EXECUTING_SCRIPT]
...
void _CCM_IM_BtTranOnSm_StaticInitInstances(void)
{
    ...
    for (chipIdx = 0; chipIdx < MCP_HAL_MAX_NUM_OF_CHIPS; ++chipIdx)
    {
        ...
        _ccmIm_BtTranOnSm_Data.smObjs[chipIdx].ccmaObj = NULL;
        _ccmIm_BtTranOnSm_Data.smObjs[chipIdx].parentCb = NULL;
        _ccmIm_BtTranOnSm_Data.smObjs[chipIdx].ccmaParentCb = NULL;
    }
}
 ...
 */
_CcmImStatus _CCM_IM_BtTranOnSm_HandlerTurnHciOn(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                 void *eventData)
{
    _CcmImStatus status;
	EMcpfRes eRes;
    ...
    /* Replace the current CCMA manager callback with mine, so that I receive
     * the events that I need for my state machine.

     * The current callback is saved. It will be restored when we Complete / Abort
     * the Transport-On process */
	CCMA_changeCallBackFun(thisObj->ccmaObj,
                           _CCM_IM_BtTranOnSm_CcmaMngrCb,
                           &thisObj->ccmaParentCb);

    /* Initiate the basic initialization of the transport. */
	eRes = CCMA_TransportOn(thisObj->ccmaObj);
    MCP_VERIFY_FATAL((eRes == RES_OK),
                     _CCM_IM_STATUS_INTERNAL_ERROR, 
                     ("_CCM_IM_BtTranOnSm_HandlerTurnHciOn: CCMA_TransportOn Failed"));
...
/*
 *  This function is called when the transport completed the basic initialization.
 *  HCI reset was already sent to the chip.
 *
 *  What must be done now is start sending the correct BT init script. To that end,
 *  we must know the file's name.
 *  The file name is generated from information stored in the LMP Subversion fields.
 *  These fields are retrieved via the Read Local Version HCI command.
 */
_CcmImStatus _CCM_IM_BtTranOnSm_HandlerReadVersion(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                   void *eventData)
{
    _CcmImStatus    status;
    EMcpfRes 		eRes;
	...
	eRes = CCMA_MngrSendHciCommand(thisObj->ccmaObj,    
								   CCMA_HCI_CMD_READ_LOCAL_VERSION, 
								   NULL,
                                   0);

    MCP_VERIFY_ERR((eRes == RES_OK),
                   _CCM_IM_STATUS_INTERNAL_ERROR,
                   ("_CCM_IM_BtTranOnSm_HandlerTurnHciOn: CCMA_TransportOn Failed"));
 ...
 *
 *  The LMP Subversion fields will be extracted from the HCI event and init
 *  script execution will start using the Script Processor.
 */
_CcmImStatus _CCM_IM_BtTranOnSm_HandlerExecuteScript(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                     void *eventData)
{
    _CcmImStatus                status;
    ...
    ccmaMngrEvent = (CcmaMngrEvent *)eventData;
    hciEventData = &ccmaMngrEvent->data.hciEventData;

    /* Get Init Script file name */
    status = _CCM_IM_BtTranOnSm_GetInitScriptFileName(thisObj,
                                                      hciEventData->parms,
                                                      scriptFileName,
                                                      scriptFullFileName);
    MCP_VERIFY_FATAL((status == _CCM_IM_STATUS_SUCCESS),
                     status,
    ...
    btsSpStatus = MCP_BTS_SP_ExecuteScript(&scriptLocation,
                                           &scriptCbData,
                                           &thisObj->btsSpContext);
...
/*
 *  This function is called by the SM engine when CCMA completes sending
 *  a radio command (initiated via the call to CCMA_MngrSendRadioCommand).
 *  Radio commands are sent to CCMA when the script processor sends an HCI command
*/
_CcmImStatus _CCM_IM_BtTranOnSm_HandlerScriptCmdCompleted(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                          void *eventData)
{
    _CcmImStatus     status;
    CcmaMngrEvent    *ccmaMngrEvent;
    ...
    /* Notify the script processor that the HCI command completed to let it
     * continue script processing */
    MCP_BTS_SP_HciCmdCompleted(&thisObj->btsSpContext,
                               hciEventData->parms,
                               hciEventData->parmLen);
...
/*
 *  This function is called the SM engine when CCMA completes setting the
 *  transport parameters (initiated via the call to CCMA_MngrSetTranParms).
 *  Transport parameters are sent to BT_HCI_If when the script processor sends
 *  a set transport parameters command
 */
_CcmImStatus _CCM_IM_BtTranOnSm_HandlerScriptSetTranParmsCompleted(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                                   void *eventData)
{
    _CcmImStatus status;
...
/*
 *  This function is called when an abort event is sent to the SM from the parent
 *  while the SM is waiting for CCMA_TransportOn to complete.
 */
_CcmImStatus _CCM_IM_BtTranOnSm_HandlerAbortTurnHciOn(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                      void *eventData)
{
    MCP_UNUSED_PARAMETER(thisObj);
    MCP_UNUSED_PARAMETER(eventData);

    /* The process will be aborted when the HCI On Completed event will arrive,
...
/*
 *  This function is called when an abort event is sent to the SM from the parent
 *  while the SM is waiting for the HCI Read Local Version command to complete
 */
_CcmImStatus _CCM_IM_BtTranOnSm_HandlerAbortReadVersion(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                        void *eventData)
{
    MCP_UNUSED_PARAMETER(thisObj);
    MCP_UNUSED_PARAMETER(eventData);

    /* Do Nothing, Wait for version to be read and continue handling in the
     * corresponding handler (the state indicates that the process should be aborted) */
...
/*
 *  This function is called when an abort event is sent to the SM from the parent
 *  while the script processor is executing the init script. 
 */
_CcmImStatus _CCM_IM_BtTranOnSm_HandlerAbortExecuteScript(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                          void *eventData)
{
    _CcmImStatus    status;
    McpBtsSpStatus  btsSpStatus;
    ...
    /* Requesting Script Processor to abort script execution. Waiting for script
     * execution completion event to abort then */
    btsSpStatus = MCP_BTS_SP_AbortScriptExecution(&thisObj->btsSpContext);
    MCP_VERIFY_FATAL((btsSpStatus == MCP_BTS_SP_STATUS_PENDING),
                     _CCM_IM_STATUS_INTERNAL_ERROR,
                     ("_CCM_IM_BtTranOnSm_HandlerAbortExecuteScript: MCP_BTS_SP_AbortScriptExecution Failed (%d)",
                      btsSpStatus));
 ...
 */
_CcmImStatus _CCM_IM_BtTranOnSm_HandlerTranOnCompleted(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                       void *eventData)
{
    MCP_UNUSED_PARAMETER(eventData);
 ...
 */
_CcmImStatus _CCM_IM_BtTranOnSm_HandlerOnFailed(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                void *eventData)
{
    MCP_UNUSED_PARAMETER(eventData);
...
/*
 *  This function is called when the process was aborted as a result of an abort
 *  request from the parent 
 */
_CcmImStatus _CCM_IM_BtTranOnSm_HandlerTranOnAbortCompleted(_CcmIm_BtTranOnSm_Obj *thisObj,
                                                            void *eventData)
{
    MCP_UNUSED_PARAMETER(eventData);
                                                  ...
                                                  _CcmImStatus completionStatus)
{
    ...
    /* Restore the parent's CCMA manager callback */
	CCMA_changeCallBackFun(thisObj->ccmaObj, thisObj->ccmaParentCb, NULL);

    MCP_LOG_INFO(("_CCM_IM_BtTranOnSm_PerformCompletion: BT Tran On Completed (status: %d), Calling Parent",
                  completionStatus));
    
    /* Notify parent SM (BtTranSm) of completion and its status. BtTranOnSm is not
     * aware of the id of the stack that initiated Bt Tran On. It is up to the
     * parent SM to record this information. */
 ...
 *
 *  The SM engine is called to process the event. This function maps the CCMA event
 *  to an SM engine event before forwarding it to the SM engine
 */
void _CCM_IM_BtTranOnSm_CcmaMngrCb(CcmaMngrEvent *event)
{
    _CcmIm_BtTranOnSm_Obj *smObj = &_ccmIm_BtTranOnSm_Data.smObjs[MCP_HAL_CHIP_ID_0];

    _CcmIm_BtTranOnSm_Event tranOnSmEvent;
    
    MCP_FUNC_START("_CCM_IM_BtTranOnSm_CcmaMngrCb");

    MCP_VERIFY_FATAL_NO_RETVAR((smObj->ccmaObj == event->reportingObj),
                               ("Mismatching BT HCI If Objs"));
    
    switch (event->type)
    {
        case CCMA_MNGR_EVENT_TRANPORT_ON_COMPLETED:
            if (event->status == CCMA_STATUS_SUCCESS)
            {
        ...
        case CCMA_MNGR_EVENT_SEND_RADIO_CMD_COMPLETED:
            tranOnSmEvent = _CCM_IM_BT_TRAN_ON_SM_EVENT_HCI_COMMMAND_COMPLETE;
            break;

        case CCMA_MNGR_EVENT_SET_TRANS_PARMS_COMPLETED:
            tranOnSmEvent = _CCM_IM_BT_TRAN_ON_SM_EVENT_SET_TRAN_PARMS_COMPLETE;
            break;

        default:
            MCP_FATAL_NO_RETVAR(("_CCM_IM_BtTranOnSm_CcmaMngrCb: Unexpected Event (%d)",
                                 event->type));
    }
...
/*
 *  This function generates an init script file name from the local version
 *  information returned in the HCI event
 */
                                                      ...
                                                      McpUtf8 *scriptFileFullName)
{
    ...
    lmpSubversion =
        MCP_ENDIAN_LEtoHost16(&hciReadVersionEventParms[_CcmIm_BtTranOnSm_HciLocalVersionLmpSubversionPos]);
...
/*
 *  This module sends the HCI command via CCMA. This function should be called
 *  only for init script loading as it is using CCMA_MngrSendRadioCommand
 */
                                                 ...
                                                 McpUint hciCmdParmsLen)
{
	...
	eRes = CCMA_MngrSendHciCommand(smObj->ccmaObj,
                                   hciOpcode,
                                   hciCmdParms,
    ...
    MCP_VERIFY_ERR((eRes == RES_OK),
                   _CCM_IM_STATUS_INTERNAL_ERROR,
                   ("_CCM_IM_BtTranOnSm_HandlerTurnHciOn: CCMA_MngrSendHciCommand Failed"));
	...
	{
		status = MCP_BTS_SP_STATUS_FAILED;
	}
    MCP_FUNC_END();
...
/*
 *  This function is called by the script processor when it needs to configure
 *  the transport parameters during execution of the BT init script
 */
McpBtsSpStatus _CCM_IM_BtTranOnSm_SpSetTranParmsCmdCb(McpBtsSpContext *context,
                                                      McpUint speed, 
                                                      McpBtSpFlowControlType flowCtrlType)
{
    McpBtsSpStatus          status = MCP_BTS_SP_STATUS_FAILED;
    EMcpfRes               	eRes;
    CcmaTranParms           ccmaTanParms;
    _CcmIm_BtTranOnSm_Obj   *smObj = &_ccmIm_BtTranOnSm_Data.smObjs[MCP_HAL_CHIP_ID_0];
    ...
    ccmaTanParms.parms.uartParms.speed = speed;
    
	eRes = CCMA_SetTranParms (smObj->ccmaObj, &ccmaTanParms);
    /* Transport parameters setting may complete synchronously or asynchronously */
    if (eRes == RES_OK)
    {
        status = MCP_BTS_SP_STATUS_SUCCESS;
/*   else if (ccmaStatus == CCMA_STATUS_PENDING)
    {
        status = MCP_BTS_SP_STATUS_PENDING;
*/
    }
    else
    {
        MCP_FATAL(MCP_BTS_SP_STATUS_INTERNAL_ERROR,
                  ("_CCM_IM_BtTranOnSm_HandlerTurnHciOn: CCMA_MngrSetTranParms Failed"));
    }
...
/*
 *  This function is called by the script processor when it completed executing
 *  the script. 
 *
 ...
 */
void _CCM_IM_BtTranOnSm_SpExecCompleteCmdCb(McpBtsSpContext *context,
                                            McpBtsSpStatus status)
{
    _CcmIm_BtTranOnSm_Obj *smObj = &_ccmIm_BtTranOnSm_Data.smObjs[MCP_HAL_CHIP_ID_0];
...
const char *_CCM_IM_BtTranOnSm_DebugStatetStr(_CcmIm_BtTranOnSm_State state)
{
    switch (state)
    {
        case _CCM_IM_BT_TRAN_ON_SM_STATE_NONE:
            return "TRAN_ON_SM_STATE_NONE";
        case _CCM_IM_BT_TRAN_ON_SM_STATE_TURN_HCI_ON:
            return "TRAN_ON_SM_STATE_TURN_HCI_ON";
        case _CCM_IM_BT_TRAN_ON_SM_STATE_ABORT_TURN_HCI_ON:
            return "TRAN_ON_SM_STATE_ABORT_TURN_HCI_ON";
        case _CCM_IM_BT_TRAN_ON_SM_STATE_READ_VERSION:
            return "TRAN_ON_SM_STATE_READ_VERSION";
        case _CCM_IM_BT_TRAN_ON_SM_STATE_ABORT_READ_VERSION:
            return "TRAN_ON_SM_STATE_ABORT_READ_VERSION";
        case _CCM_IM_BT_TRAN_ON_SM_STATE_EXECUTING_SCRIPT:
            return "TRAN_ON_SM_STATE_EXECUTING_SCRIPT";
        case _CCM_IM_BT_TRAN_ON_SM_STATE_ABORT_EXECUTING_SCRIPT:
            return "TRAN_ON_SM_STATE_ABORT_EXECUTING_SCRIPT";
        default:
            return "INVALID BT TRAN ON SM STATE";
    }
}
...
const char *_CCM_IM_BtTranOnSm_DebugEventStr(_CcmIm_BtTranOnSm_Event event)
{
    switch (event)
    {
        case _CCM_IM_BT_TRAN_ON_SM_EVENT_START:
            return "TRAN_ON_SM_EVENT_START";
        case _CCM_IM_BT_TRAN_ON_SM_EVENT_HCI_IF_ON_COMPLETE:
            return "TRAN_ON_SM_EVENT_HCI_IF_ON_COMPLETE";
        case _CCM_IM_BT_TRAN_ON_SM_EVENT_HCI_IF_ON_FAILED:
            return "TRAN_ON_SM_EVENT_HCI_IF_ON_FAILED";
        case _CCM_IM_BT_TRAN_ON_SM_EVENT_SET_TRAN_PARMS_COMPLETE:
            return "TRAN_ON_SM_EVENT_SET_TRAN_PARMS_COMPLETE";
        case _CCM_IM_BT_TRAN_ON_SM_EVENT_HCI_COMMMAND_COMPLETE:
            return "TRAN_ON_SM_EVENT_HCI_COMMMAND_COMPLETE";
        case _CCM_IM_BT_TRAN_ON_SM_EVENT_SCRIPT_EXEC_COMPLETE:
            return "TRAN_ON_SM_EVENT_SCRIPT_EXEC_COMPLETE";
        case _CCM_IM_BT_TRAN_ON_SM_EVENT_ABORT:
            return "TRAN_ON_SM_EVENT_ABORT";
        default:
            return "INVALID BT TRAN ON SM EVENT";
    }
}
