                                       ...
                                       _CcmIm_BtTranMngr_Obj **thisObj)
{
    ...
    *thisObj = &_ccmIm_BtTranMngr_Data.tranMngrObjs[chipId];
	...
	status  = _CCM_IM_BtTranSm_Create(	hMcpf,
										(*thisObj)->chipId,
...
_CcmImStatus _CCM_IM_BtTranMngr_Destroy(_CcmIm_BtTranMngr_Obj **thisObj)
{
    ...
    MCP_FUNC_START("_CCM_IM_BtTranMngr_Destroy");
                                       ...
                                       McpU16 *versionMinor)
{
    ...
    _CCM_IM_BtTranSm_GetChipVersion(thisObj->tranSmObj,
                                    projectType,
                                    versionMajor,
                                    versionMinor);
...
{
    return CCM_IM_BtTranSm_GetCcmaObj(smData->tranSmObj);
}
...
const char *_CCM_IM_BtTranMngr_DebugEventStr(_CcmIm_BtTranMngr_Event event)
{
    ...
    {
        case _CCM_IM_BT_TRAN_MNGR_EVENT_TRAN_OFF:
            return "BT_TRAN_MNGR_EVENT_TRAN_OFF";
        case _CCM_IM_BT_TRAN_MNGR_EVENT_TRAN_ON_ABORT:
            return "BT_TRAN_MNGR_EVENT_TRAN_ON_ABORT";
        case _CCM_IM_BT_TRAN_MNGR_EVENT_TRAN_ON:
            return "BT_TRAN_MNGR_EVENT_TRAN_ON";            
        default:
            return "INVALID BT TRAN SM EVENT";
    }
}
